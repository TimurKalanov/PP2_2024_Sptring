...
red = pygame.Color(255, 0, 0)  # изменяем цвет головы змейки на красный
...
while True:
	...
	for pos_index, pos in enumerate(snake_body):
		if pos_index == 0:  # Проверяем, если это голова змейки
			pygame.draw.rect(game_window, red,
							pygame.Rect(pos[0], pos[1], 10, 10))
		else:
			pygame.draw.rect(game_window, random.choice([green, blue, white]),
							pygame.Rect(pos[0], pos[1], 10, 10))
